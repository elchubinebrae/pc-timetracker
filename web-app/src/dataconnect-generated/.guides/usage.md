...
```ts
import { useCreateUser, useListTasksForUser, useLogTime, useListProjects } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useLogTime();
...
```js
import { createUser, listTasksForUser, logTime, listProjects } from '@dataconnect/generated';
